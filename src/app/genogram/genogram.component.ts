...
>>>>>>> 93bce597dd12fe8d014c44c491b75a9dafd7bfed
  ...
  maleGeometry(a: string) {
    const arrow = go.Geometry.parse(
      'F M71 59 L 59 47 54 50 44 30 67 39 63 43 75 55'
    );
    const halfRightSquare =
      'F M20 1 l19 0 0 19 -19 0z F M20 20 l19 0 0 19 -19 0z';
    const halfLeftSquare =
      'F M5 0 L6 0 6 1 1 6 0 6 0 5 F M15 0 L16 0 16 1 1 16 0 16 0 15 F M20 5 L21 5 21 6 1 25 0 25 0 24 F M20 15 L21 15 21 16 1 35 0 35 0 34 F M20 25 L21 25 21 26 5 40 4 40 4 39 F M20 34 L21 34 21 35 14 40 13 40 13 39';
  ...
  femaleGeometry(a: string) {
    ...
    const fullCircle =
      'F M20 20 B 180 90 20 20 19 19 z ' +
      'F M20 20 B 270 90 20 20 19 19 z ' +
      'F M20 20 B 0 90 20 20 19 19 z ' +
      'F M20 20 B 90 90 20 20 19 19 z ';
    const thirdFourthCircle = 'F M20 20 B 90 90 20 20 19 19 z ';
    const fisrtFourthCircle =
      'F M20 5 L 20 6 7 6 7 5 ' +
      'F M20 10 L 20 11 3 11 3 10 ' +
      'F M20 15 L 20 16 1 16 1 15';
    const lastFourthCircle =
      'F M25 20 L 26 20 26 40 25 40 ' +
      'F M30 20 L 31 20 31 37 30 36 ' +
      'F M35 20 L 36 20 36 33 35 32 ';
    const secondFourthCircle = go.Geometry.parse(
      'F M20 20 B 270 90 20 20 19 19 z'
    );
    const slash = go.Geometry.parse('F M38 0 L40 0 40 2 2 40 0 40 0 38z');
    const fullBlackCircle = go.Geometry.parse(fullCircle);
    const pieceCircle = go.Geometry.parse(
      fisrtFourthCircle + thirdFourthCircle + lastFourthCircle
    );
    switch (a) {
      case 'DEAD':
        return slash;
      case '1DISEASE':
        return fullBlackCircle;
      case 'NDISEASE':
        return pieceCircle;
      case 'FDISEASE':
        return secondFourthCircle;
      case 'ME':
        return arrow;
      default:
        return fullBlackCircle;
